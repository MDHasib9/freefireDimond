...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-[#001F3F] backdrop-blur-md border-b border-gray-100 shadow-sm">
              ...
              <Link
                ...
                className={`group flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 ${
                  location.pathname === item.path
                    ...
                    : "text-gray-300 hover:text-blue-600 hover:bg-gray-50"
                }`}
              >
