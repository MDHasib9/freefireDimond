...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden z-10 ">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Top picks for Free Fire players. Get the best items at competitive
            prices.
          </p>
        </div>
      ...
      <section className="  from-gray-50 to-gray-100 bg-[#898989] py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            >
              <div className="text-4xl mb-4">
                {" "}
                <img className="rounded-4xl" src="evoguns.jpg" alt="" />
              </div>
